...
?>
<div class="container">
    <dif id="jdlaccr" style="font-size:36px;color;brown;">Harber Web</div>
    <div class="card shadow-sm mb-5 bg-black rounded">
        <div class="card-body">
            <h5 class="card-title">Input Name:</5>
            <p class="card-text"><input type="text" class="input 
            input.lg" style="width:100%," id=srchInv></p>
        </div>
